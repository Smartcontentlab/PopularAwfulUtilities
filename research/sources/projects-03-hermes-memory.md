...
Title: hermes-agent/website/docs/user-guide/features/memory-providers.md at main · NousResearch/hermes-agent · GitHub
Fetched: 2026-08-23T20:02:46.578Z

[Skip to content](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md) to refresh your session.Dismiss alert

{{ message }}

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md).
...
- [Fork\\
47.2k](https://github.com/login?return_to=%2FNousResearch%2Fhermes-agent)
- [Star\\
235k](https://github.com/login?return_to=%2FNousResearch%2Fhermes-agent)
...
[![teknium1](https://avatars.githubusercontent.com/u/127238744?v=4&size=40)](https://github.com/teknium1)[teknium1](https://github.com/NousResearch/hermes-agent/commits?author=teknium1)

[docs: accuracy sweep + coverage for 2 months of shipped features](https://github.com/NousResearch/hermes-agent/commit/43874d1a96134729ff65d8a0da84a38ef0fc723b)

Open commit detailssuccess

last monthJul 29, 2026

[43874d1](https://github.com/NousResearch/hermes-agent/commit/43874d1a96134729ff65d8a0da84a38ef0fc723b) · last monthJul 29, 2026

## History

[History](https://github.com/NousResearch/hermes-agent/commits/main/website/docs/user-guide/features/memory-providers.md)

Open commit details

[View commit history for this file.](https://github.com/NousResearch/hermes-agent/commits/main/website/docs/user-guide/features/memory-providers.md) History

682 lines (521 loc) · 30.2 KB
...
[Raw](https://github.com/NousResearch/hermes-agent/raw/refs/heads/main/website/docs/user-guide/features/memory-providers.md)
...
[Permalink: Memory Providers](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#memory-providers)

Hermes Agent ships with 8 external memory provider plugins that give the agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. Only **one** external provider can be active at a time — the built-in memory is always active alongside it.

## Quick Start

[Permalink: Quick Start](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#quick-start)
...
[Permalink: How It Works](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#how-it-works)
...
[Permalink: Available Providers](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#available-providers)

### Honcho

[Permalink: Honcho](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#honcho)
...
The auto-injected dialectic also scales its reasoning level by query length (longer query → deeper reasoning, capped at `reasoningLevelCap`); see [Query-Adaptive Reasoning Level](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/honcho.md#query-adaptive-reasoning-level).
...
[Permalink: New profile, fresh Honcho peer](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#new-profile-fresh-honcho-peer)
...
[Permalink: Existing profiles, backfill Honcho peers](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#existing-profiles-backfill-honcho-peers)
...
[Permalink: Per-profile observation](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#per-profile-observation)
...
See the [Honcho page](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/honcho.md#observation-directional-vs-unified) for the full observation reference.

### Gateway identity mapping

[Permalink: Gateway identity mapping](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#gateway-identity-mapping)

The peer model above covers CLI, TUI, and desktop sessions, where every conversation resolves to `peerName`. The [gateway](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/developer-guide/gateway-internals.md) adds a second axis: users arrive with platform-native runtime IDs (Telegram UID, Discord snowflake, Slack user), and three keys decide which peer each ID resolves to.
...
[Permalink: OpenViking](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#openviking)
...
[Permalink: Mem0](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#mem0)
...
[Permalink: Hindsight](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#hindsight)
...
[Permalink: Holographic](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#holographic)
...
[Permalink: RetainDB](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#retaindb)
...
[Permalink: ByteRover](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#byterover)
...
[Permalink: Supermemory](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#supermemory)
...
[Permalink: Memori](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#memori)
...
[Permalink: Provider Comparison](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#provider-comparison)
...
[Permalink: Profile Isolation](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#profile-isolation)

Each provider's data is isolated per [profile](https://github.com/NousResearch/hermes-agent/blob/main/user-guide/profiles):
...
[Permalink: Building a Memory Provider](https://github.com/NousResearch/hermes-agent/blob/main/website/docs/user-guide/features/memory-providers.md#building-a-memory-provider)

See the [Developer Guide: Memory Provider Plugins](https://github.com/NousResearch/hermes-agent/blob/main/developer-guide/memory-provider-plugin) for how to create your own.
